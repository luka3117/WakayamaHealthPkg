...
\begin{figure}[h!]
	\begin{center}
	\fbox{\includegraphics[width=0.5\linewidth]{fig/Bayes_LE_f_ccdf_F1.pdf}}
...
\begin{figure}[h!]
	\begin{center}
	\fbox{\includegraphics[width=0.5\linewidth]{fig/Bayes_LE_f_ccdf_F2.pdf}}
...
\begin{figure}[h!]
	\begin{center}
	\fbox{\includegraphics[width=0.5\linewidth]{fig/Bayes_LE_m_ccdf_F1.pdf}}
...
\begin{figure}[h!]
	\begin{center}
	\fbox{\includegraphics[width=0.5\linewidth]{fig/Bayes_LE_m_ccdf_F2.pdf}}
...
\begin{figure}[h!]
	\begin{center}
	\fbox{\includegraphics[width=0.5\linewidth]{fig/Bayes_HLE_f_ccdf_F1.pdf}}
...
\begin{figure}[h!]
	\begin{center}
	\fbox{\includegraphics[width=0.5\linewidth]{fig/Bayes_HLE_f_ccdf_F2.pdf}}
...
\begin{figure}[h!]
	\begin{center}
	\fbox{\includegraphics[width=0.5\linewidth]{fig/Bayes_HLE_m_ccdf_F1.pdf}}
...
\begin{figure}[h!]
	\begin{center}
	\fbox{\includegraphics[width=0.5\linewidth]{fig/Bayes_HLE_m_ccdf_F2.pdf}}
