...
%男性はN列「総人口(男)」、総人口女性はP列「総人口(女)」のを取得し、
%・DataFormat.csvのG列に転記
  \end{itemize}
...
%\section{}
\chapter{男女の区別がないデータ(common data)}
...
%
%本章では, 各説明変数における和歌山県の順位が低い、あるいは、順位が高い変数を一部示す。
%日本語変数名については,
...
%\begin{figure}[h!]
%	\begin{center}
%		\includegraphics[ width=0.8\linewidth]{fig/WakayamRank2.pdf}
%		\caption{和歌山県の順位2}
%	\end{center}
%\end{figure}
%
...
%\begin{figure}[h!]
%	\begin{center}
%		\includegraphics[ width=0.8\linewidth]{fig/WakayamRank3.pdf}
%		\caption{和歌山県の順位3}
%	\end{center}
%\end{figure}
%
