...
## 男女区別のあるデータ `d_mf`,`d_m`,`d_f` {.tabset .tabset-fade .tabset-pills}
...
# 説明変数の順位確認{.tabset .tabset-fade .tabset-pills}
...
# 出典整理{.tabset .tabset-fade .tabset-pills}
...
- [一定のバリアフリー化率段差のない屋内_2013][]

- [高度のバリアフリー化率手すりの設置_2013][]

- [高度のバリアフリー化率段差のない屋内_2013][]

- [高度のバリアフリー廊下等が車いすで通行可能な幅_2013][]
...
- [果物平均_世帯数消費支出(2014〜2016）][]

- [全国学力・学習状況(公立学校数)(中学校)_2015][]

- [全国学力・学習状況(公立学校数)(小学生)_2015][]
...
- [アルツハイマー等(脳血管疾患)_2014][]

- [ジニ係数総世帯_2014][]

- [収入ジニ係数勤労世帯_2014][]

- [野菜摂取量_2012(20歳以上平均値(g/日)][]
...
> vの　FH列に転記
############################################################
変数名：野菜摂取量_2012(20歳以上平均値(g/日)
出典：平成24年国民健康・栄養調査
取得元：以下のリンク
https://www.mhlw.go.jp/stf/houdou/...att/2r98520000021c39.pdf
詳細説明：
・「第２章 都道府県別の肥満及び主な生活習慣の状況」ダウンロード
・2.野菜摂取量男性(20歳以上)平均値(g/日)、女性(20歳以上)平均値(g/日)の各都道府県別の数値を取得し、
・DataFormat.csvの　FI列に転記
############################################################
変数名：食塩摂取量_2012(20歳以上平均値(g/日)
出典：平成24年国民健康・栄養調査
取得元：以下のリンク
https://www.mhlw.go.jp/stf/houdou/...att/2r98520000021c39.pdf
詳細説明：
・「第２章 都道府県別の肥満及び主な生活習慣の状況」ダウンロード
・2.食塩摂取量男性(20歳以上)平均値(g/日)、女性(20歳以上)平均値(g/日)の各都道府県別の数値を取得し、
・DataFormat.csvの　FJ列に転記
############################################################
変数名：歩数_2012(20歳以上平均値(歩/日)
出典：平成24年国民健康・栄養調査
取得元：以下のリンク
https://www.mhlw.go.jp/stf/houdou/...att/2r98520000021c39.pdf
詳細説明：
・「第２章 都道府県別の肥満及び主な生活習慣の状況」ダウンロード
・2.歩数男性(20歳以上平均値(歩/日)、女性(20歳以上平均値(歩/日)の各都道府県別の数値を取得し、
・DataFormat.csvの　FL列に転記
############################################################
